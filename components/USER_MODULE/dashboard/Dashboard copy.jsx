...
const Dashboard = ({ route, navigation }) => {
  ...
  const all_modules = [
    {
      ...
      icon: <QrCode size={24} color="#0284c7" />,
      color: "bg-sky-50",
    ...
    },
    {
      ...
      icon: <Warehouse size={24} color="#0284c7" />,
      color: "bg-sky-50",
      borderColor: "border-sky-100",
    },
    {
    ...
    },
    {
      ...
      code: "PROD",
      name: "Production",
      desc: "Receive and Dispatch of Materials",
      icon: <Pickaxe size={24} color="#0284c7" />,
      color: "bg-sky-50",
      borderColor: "border-sky-100",
    },
    {
  ...
  // 🔄 Filter logic base sa user.rf_gun_module comma-separated string
