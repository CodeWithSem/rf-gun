...
const Inventory_Stock = ({ route, navigation }) => {
  ...
  const subModules = [
    {
      id: 1,
      title: "Stock Audit",
      description: "Backroom vs. Selling Area count",
      icon: <ClipboardCheck size={24} color="#0284c7" />,
      screen: "StockAudit",
      color: "bg-sky-50",
    },
    {
      ...
      description: "Check visibility and OOS items",
      icon: <Eye size={24} color="#0d9488" />,
      screen: "OSA",
      color: "bg-teal-50",
    },
    {
      ...
      description: "Log near-expiry items (FEFO)",
      icon: <CalendarClock size={24} color="#ca8a04" />,
      screen: "ExpiryTracking",
      color: "bg-amber-50",
    },
    {
      id: 4,
      title: "Returns / Bad Orders",
      description: "Damaged or expired pull-outs",
  ...
  return (
    <SafeAreaView className="flex-1 bg-white" edges={["top"]}>
      ...
      >
        {/* Instruction Card */}
        <View className="bg-sky-600 rounded-xl p-5 mb-6 shadow-sm shadow-sky-200">
          ...
          <Text
            style={{ fontFamily: "Outfit-Regular" }}
            className="text-sky-50 text-xs leading-relaxed"
          >
            Please complete the Stock Audit before proceeding to Returns. Ensure
            all FEFO protocols are followed during Expiry Tracking.
          </Text>
        </View>
